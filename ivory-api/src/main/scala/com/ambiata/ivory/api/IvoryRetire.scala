...
object IvoryRetire {
  ...
  val pivot = com.ambiata.ivory.operation.extraction.output.PivotOutput.createPivot _
  val pivotFromSnapshot = com.ambiata.ivory.operation.extraction.output.PivotOutput.createPivotFromSnapshot _
