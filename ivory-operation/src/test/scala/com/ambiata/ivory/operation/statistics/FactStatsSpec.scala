...
class FactStatsSpec extends Specification with ThrownExpectations with FileMatchers { def is = sequential ^ s2"""
  ...
  val facts1 = Seq(StringFact("eid1",  FeatureId(Name("ns1"), "fid1"), Date(2012, 10, 1), Time(0), "horus"),
                   ...
                   StringFact("eid4",  FeatureId(Name("ns1"), "fid1"), Date(2012, 10, 1), Time(0), "anubis"),
                   StringFact("eid4",  FeatureId(Name("ns1"), "fid1"), Date(2012, 10, 1), Time(0), "anubis"),
                   StringFact("eid5",  FeatureId(Name("ns1"), "fid1"), Date(2012, 10, 1), Time(0), "isis")
                  )
  val facts2 = Seq(IntFact("eid1",     FeatureId(Name("ns1"), "fid2"), Date(2012, 10, 2), Time(0), 1),
                   IntFact("eid3",     FeatureId(Name("ns1"), "fid2"), Date(2012, 10, 2), Time(0), 9)
               )
