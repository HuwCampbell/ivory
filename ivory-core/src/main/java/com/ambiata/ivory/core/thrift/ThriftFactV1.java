...
public class ThriftFactV1 implements org.apache.thrift.TBase<ThriftFactV1, ThriftFactV1._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftFactV1> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ThriftFactV1");
  ...
  static {
    schemes.put(StandardScheme.class, new ThriftFactV1StandardSchemeFactory());
    schemes.put(TupleScheme.class, new ThriftFactV1TupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ThriftFactV1.class, metaDataMap);
  }
   ...
   */
  public ThriftFactV1(ThriftFactV1 other) {
  ...
  public ThriftFactV1 deepCopy() {
    return new ThriftFactV1(this);
  }
  ...
  public ThriftFactV1 setEntity(String entity) {
    this.entity = entity;
    return this;
  }
  ...
  public ThriftFactV1 setAttribute(String attribute) {
    this.attribute = attribute;
    return this;
  }
  ...
  public ThriftFactV1 setValue(ThriftFactValue value) {
    this.value = value;
    return this;
  }
  ...
  public ThriftFactV1 setSeconds(int seconds) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ThriftFactV1)
      return this.equals((ThriftFactV1)that);
    return false;
  }

  public boolean equals(ThriftFactV1 that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ThriftFactV1 other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ThriftFactV1(");
    boolean first = true;
  ...
  private static class ThriftFactV1StandardSchemeFactory implements SchemeFactory {
    public ThriftFactV1StandardScheme getScheme() {
      return new ThriftFactV1StandardScheme();
    }
  }

  private static class ThriftFactV1StandardScheme extends StandardScheme<ThriftFactV1> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ThriftFactV1 struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftFactV1 struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ThriftFactV1TupleSchemeFactory implements SchemeFactory {
    public ThriftFactV1TupleScheme getScheme() {
      return new ThriftFactV1TupleScheme();
    }
  }

  private static class ThriftFactV1TupleScheme extends TupleScheme<ThriftFactV1> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ThriftFactV1 struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ThriftFactV1 struct) throws org.apache.thrift.TException {
