 ...
 * access a private field. Can be removed when
 * <a href="https://github.com/apache/thrift/pull/171"> this change</a> has been
 * released and we upgrade.
 */
public class TDeserializerCopy {
     ...
     */
    public TDeserializerCopy(TProtocolFactory protocolFactory) {
