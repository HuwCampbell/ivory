...
public class ThriftFactTest implements org.apache.thrift.TBase<ThriftFactTest, ThriftFactTest._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftFactTest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ThriftFactTest");
  ...
  static {
    schemes.put(StandardScheme.class, new ThriftFactTestStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ThriftFactTestTupleSchemeFactory());
  }

  public String entity; // required
  public String attribute; // required
  public com.ambiata.ivory.core.thrift.ThriftFactValue value; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.VALUE, new org.apache.thrift.meta_data.FieldMetaData("value", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.ambiata.ivory.core.thrift.ThriftFactValue.class)));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ThriftFactTest.class, metaDataMap);
  }

  public ThriftFactTest() {
  }

  public ThriftFactTest(
    String entity,
    String attribute,
    com.ambiata.ivory.core.thrift.ThriftFactValue value,
    int seconds)
  {
    this();
    this.entity = entity;
   ...
   */
  public ThriftFactTest(ThriftFactTest other) {
    ...
    if (other.isSetValue()) {
      this.value = new com.ambiata.ivory.core.thrift.ThriftFactValue(other.value);
    }
    this.seconds = other.seconds;
  }

  public ThriftFactTest deepCopy() {
    return new ThriftFactTest(this);
  }
  ...
  public ThriftFactTest setEntity(String entity) {
    this.entity = entity;
    return this;
  }
  ...
  public ThriftFactTest setAttribute(String attribute) {
    this.attribute = attribute;
    return this;
  }
  ...
  public com.ambiata.ivory.core.thrift.ThriftFactValue getValue() {
    return this.value;
  }

  public ThriftFactTest setValue(com.ambiata.ivory.core.thrift.ThriftFactValue value) {
    this.value = value;
    return this;
  }
  ...
  public ThriftFactTest setSeconds(int seconds) {
    this.seconds = seconds;
    setSecondsIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case VALUE:
      if (value == null) {
        ...
        setValue((com.ambiata.ivory.core.thrift.ThriftFactValue)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ThriftFactTest)
      return this.equals((ThriftFactTest)that);
    return false;
  }

  public boolean equals(ThriftFactTest that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ThriftFactTest other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ThriftFactTest(");
    boolean first = true;
  ...
  private static class ThriftFactTestStandardSchemeFactory implements SchemeFactory {
    public ThriftFactTestStandardScheme getScheme() {
      return new ThriftFactTestStandardScheme();
    }
  }

  private static class ThriftFactTestStandardScheme extends StandardScheme<ThriftFactTest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ThriftFactTest struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 3: // VALUE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.value = new com.ambiata.ivory.core.thrift.ThriftFactValue();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftFactTest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ThriftFactTestTupleSchemeFactory implements SchemeFactory {
    public ThriftFactTestTupleScheme getScheme() {
      return new ThriftFactTestTupleScheme();
    }
  }

  private static class ThriftFactTestTupleScheme extends TupleScheme<ThriftFactTest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ThriftFactTest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ThriftFactTest struct) throws org.apache.thrift.TException {
